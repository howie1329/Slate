...
The MVP is intentionally small but complete: local SQLite persistence, secure macOS Keychain storage for BYOK credentials, menu-bar access, and two optional AI actions using Vercel AI SDK v7 with Vercel Gateway or OpenRouter.
